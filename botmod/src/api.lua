...
local ACTION_DISPATCH = {
    ...
    [Bot.ACTIONS.SELECT_HAND_CARD] = function(action) Actions.select_hand_card(action[2]) end,
    ...
    [Bot.ACTIONS.SELECT_BOOSTER_CARD] = function(action) Actions.select_booster_card(action[2]) end,
    ...
    [Bot.ACTIONS.USE_CONSUMABLE] = function(action) Actions.use_consumable(action[2]) end,
